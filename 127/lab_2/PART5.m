...
PART2_DAT=[noisepower; highfreq; lowfreq; popup; analog; N; highfreqf_field; lowfreq_field; noisepower_field; t(:); ];                                 
...
elseif strcmp(action,'redraw'),                                       
    ...
    noisepower=PART2_DAT(1);                                             
    highfreq=PART2_DAT(2);                                                
    lowfreq=PART2_DAT(3);                                                 
    popup=PART2_DAT(4);                                               
    analog=PART2_DAT(5);                                              
    N=PART2_DAT(6);                                                   
    highfreqf_field=PART2_DAT(7);                                         
    lowfreq_field=PART2_DAT(8);
    noisepower_field=PART2_DAT(9);	                                         
...
elseif strcmp(action,'sethighfreq'),                                     
    ...
    elseif (xf >20),                                                   		
        set(PART2_DAT(7),'string',num2str(20));                        
        xf=20;                                                        
        PART2_DAT(2)=xf;                                               
    else                                                              
    PART2_DAT(2)=xf;                                                   
...
elseif strcmp(action,'setnoisepower'),                                     
	...
	if isempty(xf),   % handle the non-numeric case                       
        set(PART2_DAT(9),'string',num2str(PART2_DAT(1)));               
    elseif (xf >20),                                                   		
        set(PART2_DAT(9),'string',num2str(20));                        
        xf=20;                                                        
        PART2_DAT(1)=xf;                                               
    else                                                              
    PART2_DAT(1)=xf;                                                   
