...
PART1_DAT=[noisepower; highamp; lowamp; popup; analog; N; highampf_field; lowamp_field; noisepower_field; t(:); ];                                 
...
elseif strcmp(action,'redraw'),                                       
    ...
    noisepower=PART1_DAT(1);                                             
    highamp=PART1_DAT(2);                                                
    lowamp=PART1_DAT(3);                                                 
    popup=PART1_DAT(4);                                               
    analog=PART1_DAT(5);                                              
    N=PART1_DAT(6);                                                   
    highampf_field=PART1_DAT(7);                                         
    lowamp_field=PART1_DAT(8);                                         
    noisepower_field=PART1_DAT(9);                                                  
...
elseif strcmp(action,'setnoisepower'),                                     
	...
	if isempty(xf),   % handle the non-numeric case                       
        set(PART1_DAT(9),'string',num2str(PART1_DAT(1)));               
    elseif (xf > 20),                                                   		
        set(PART1_DAT(9),'string',num2str(20));                        
        xf=20;                                                        
        PART1_DAT(1)=xf;                                               
    else                                                              
    PART1_DAT(1)=xf;                                                   
...
if isempty(xf),   % handle the non-numeric case                       
    ...
    elseif (xf>10),                                                   
        set(PART1_DAT(7),'string',num2str(10));                        
        xf=10;                                                        
        PART1_DAT(2)=xf;                                               
    else                                                              
    PART1_DAT(2)=xf;                                                   
