...
if strcmp(action,'start'),                                            
    ...
    set(gcf, ...                                                      
        'NumberTitle','off', ...                                      
        'Name','Part 1 - Signal Characteristics', ...                      
        'backingstore','off',...                                      
        'Units','normalized');                                        
...
val = get(popup,'Value');                                         
if (val == 1),                                                    
        f=amp*sin(freq*t*2*pi);  			% sinusoidal wave                             
elseif (val == 2),                                                
...
%   ax_dit=axes('Position',[.12 .14 .6 .3],'Xlim', [0 fsample],'YLim',[-1*amp-(.25*amp) 1*amp+(0.25*amp)]);                                                   
...
%nn=0:length(fff)-1;                                                   
%stem(nn,fff);                                                         
%axis([0 length(nn) -1*amp-.25*amp 1*amp+0.25*amp]);                   
...
PART1_DAT=[fsample; freq; amp; popup; analog; N; freqf_field; amp_field; k; t(:); ];                                 
...
elseif strcmp(action,'redraw'),                                       
     ...
     N=PART1_DAT(6);                                                   
 %    ax_dit=PART1_DAT(7);                                              
     freqf_field=PART1_DAT(7);                                         
    amp_field=PART1_DAT(8);                                         
     k=PART1_DAT(9);                                                  
     t=PART1_DAT(10:10+N-1);                                           
%     amp_field=PART1_DAT(11);                                         
...
if isempty(xf),   % handle the non-numeric case                       
        set(PART1_DAT(7),'string',num2str(PART1_DAT(2)));               
    elseif (xf>60),                                                   
        set(PART1_DAT(7),'string',num2str(60));                        
        xf=60;                                                        
        PART1_DAT(2)=xf;                                               
    else                                                              
    PART1_DAT(2)=xf;                                                   
...
if isempty(xf),   % handle the non-numeric case                       
        set(PART1_DAT(8),'string',num2str(PART1_DAT(3)));               
    elseif (xf>10),                                                   
        set(PART1_DAT(8),'string',num2str(10));                        
        xf=10;                                                        
        PART1_DAT(3)=xf;                                               
    else                                                              
    PART1_DAT(3)=xf;                                                   
