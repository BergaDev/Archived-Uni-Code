...
public class UserInterface1 // different designs  
{
    ...
    public static void mainMenu(InsuranceCompany insuranceCompany) throws CloneNotSupportedException
    {
    ...
    public static void adminLogin(InsuranceCompany insuranceCompany) throws CloneNotSupportedException
    {
    ...
    public static void displayAdminMainMenu()
    {
        ...
        System.out.println("10) Test case with copy stuff");
        System.out.println("\n\nSelect and Option from 1-9");
    }
    
    public static void adminMenu(InsuranceCompany insuranceCompany) throws CloneNotSupportedException
    {
        Scanner sc = new Scanner(System.in);
        int option = 0;
        while (option != 9){
...
//    public static void userMainMenu(InsuranceCompany insuranceCompany, int userID) 
//    {
//        Scanner sc = new Scanner(System.in);
//        int input = 0;
//        while (input != 7)
...
//        addUser(insuranceCompany,new User(userID, name, new Address(steetNum, streetName, suburb, city), username, password));
    ...
    public static void createThirdPartyPolicy1(InsuranceCompany insuranceCompany) // I keep it to show that this also can be done
    {
        Scanner sc = new Scanner(System.in);
...
//        MyDate expiryDate = new MyDate(year, month, day);
        ...
        UITools.addThirdPartyPolicy(insuranceCompany, userID, policyHolderName, policyID, car, numberOfClaims, expiryDate, comments);
        //or this one by creating the policy and calling addPolicy
        UITools.addPolicy(insuranceCompany, userID, new ThirdPartyPolicy (policyHolderName,policyID, car, numberOfClaims, expiryDate, comments));       
    }
    ...
    public static void createComprehensivePolicy1(InsuranceCompany insuranceCompany) // I keep it to show that this also can be done
    {
        Scanner sc = new Scanner(System.in);
...
//        MyDate expiryDate = new MyDate(year, month, day);
        ...
        UITools.addComprehensivePolicy(insuranceCompany, userID, policyHolderName, policyID, car, numberOfClaims, expiryDate, driverAge, level);
        //or this one by creating the policy and calling addPolicy
        UITools.addPolicy(insuranceCompany, userID, new ComprehensivePolicy (policyHolderName, policyID, car, numberOfClaims, expiryDate, driverAge, level));
    }
