...
public class TestCase 
{
  ...
  public static ArrayList<InsurancePolicy> policies = new ArrayList<>(); //ArrayList of parent class, NOW STATIC
    public static void testCode(InsuranceCompany insuranceCompany) throws CloneNotSupportedException
    {
        double flatRate=12;
	...
	Address address1 = new Address(7,"Lincoln St","Westfield","New York");
        ...
        User user1 = new User(1345,"Jeff",address1,"pass1");
...
//            InsurancePolicy.printPolicies(filteredList);
        ...
        */
        ...
        System.out.println("We have reached this comment; This is the bottom of the Assignment 1 test case");

        user1.sortPoliciesByDate();

        System.out.println("Policy sorting has worked, i think");

        InsurancePolicy.deepCopy(policies);

        System.out.println("That is that deepCopy done");

        InsurancePolicy.shallowCopy(policies);

        System.out.println("And that is shallow copy");

        //User.sortUsers(); Need to work on this 
