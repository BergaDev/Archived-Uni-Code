...
//    }
    ...
    public ArrayList<User>shallowCopyUsers(ArrayList<User>users){
      ...
      shallowCopyUsers = (ArrayList) users.clone();
    ...
    public ArrayList<User>deepCopy(ArrayList<User>users){
      ...
      for(User user : users){
        ...
        deepCopyUsers =(ArrayList) users.clone();
      }
    ...
    public ArrayList<User> sortUsers(){
     ...
     Compare to cityname and return
    public int compareTo(User st, String cityName){
      ArrayList<InsuranceCompany> sortedByCity = new ArrayList<>();
      this.cityName = cityName;
      
      for(InsurancePolicy policy : policies){

      
          if(InsurancePolicy.policies.getCity == cityName){
            sortedByCity.add(policy);
          }
